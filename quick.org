...
Val is tasked with retrieving Kevin who has been kidnapped. Kevin is the son of a Timothy Wells, a politician. Timothy has asked (The order) [a law enforcement organization] to retrieve Kevin. Timothy is being blackmailed to do something that is treasonous against the state.
